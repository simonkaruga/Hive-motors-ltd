...
export default function RangeRoverPage() {
  ...
  const car = {
    ...
    status: 'available',
    images: [
      '/cars/range-rover/range-rover-01.jpg',
      '/cars/range-rover/range-rover-02.jpg',
      '/cars/range-rover/range-rover-03.jpg',
      '/cars/range-rover/range-rover-04.jpg',
      '/cars/range-rover/range-rover-05.jpg',
    ],
    features: [
      ...
      'Digital Cluster',
      'Touch Screen Front & Rear Infotainment Display',
      'Ambient Sound Surround System',
      'Multimedia Interface with Radio, AUX, USB, DVD, Bluetooth',
      'Electric Seats with Warmers/Coolers',
      'All-Terrain Driving Modes',
      'Memory Seats',
      'All Xenon Lights with Daytime Running LED',
      'Reverse Camera',
      'Cruise Control',
      'Paddle Shifts',
      'Auto Boot Lock',
  ...
  const similarCars = [
    ...
    { title: '2018 BMW X5', price: 8500000, year: 2018, mileage: 55000, image: '/cars/range-rover/range-rover-02.jpg' },
    { title: '2019 Mercedes GLE', price: 9200000, year: 2019, mileage: 48000, image: '/cars/range-rover/range-rover-03.jpg' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-mid-grey leading-relaxed">
            3.0L turbocharged diesel engine with 8-Speed Automatic Transmission. This stunning Range Rover Sport HSE features 72k kms mileage, beige leather seats, and a panoramic sunroof. Equipped with advanced features including HUD (Heads Up Display), BSM (Blind Spot Monitor), digital cluster, and touch screen front & rear infotainment displays. Enjoy the ambient sound surround system, all-terrain driving modes, and memory seats with warmers/coolers.
          </p>
        </div>
