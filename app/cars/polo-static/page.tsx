...
export default function PoloPage() {
  ...
  const car = {
    ...
    features: [
      '1000cc Turbocharged Petrol Engine',
      '7-Speed Automatic Transmission',
      'Digital Cluster',
      '22k kms Mileage',
      'Fabric Seats',
      'VW Music Interface with Radio, USB, Bluetooth, DVD',
      ...
      'Powered Door Locks/Windows/Mirrors',
      'Manual Handbrake',
      'Traction Control',
  ...
  const similarCars = [
    ...
    { title: '2019 Peugeot 3008', price: 3350000, year: 2019, mileage: 41000, image: '/cars/3008/3008-01.jpg' },
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-mid-grey leading-relaxed">
            2019 VW Polo Highline MK7.5 with 1000cc turbocharged petrol engine and 7-Speed Automatic Transmission. Features digital cluster, premium sound surround system, dual zone climate settings, and only 22k kms mileage. Equipped with reverse camera, parking assist monitor, cruise control, and auto start-stop system for maximum fuel efficiency.
          </p>
        </div>
