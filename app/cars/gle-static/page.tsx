...
export default function GLEPage() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setSelectedImage((prev) => (prev + 1) % 8);
    }, 4000);
  ...
  const car = {
    ...
    features: [
      ...
      '3000cc Turbocharged Diesel Engine',
      '330 BHP',
      '700nm of Torque',
      '50k kms Mileage',
      'Panoramic Sunroof',
      'MultiMedia Display with Radio, DVD, USB, AUX, Bluetooth, Apple CarPlay',
      'Warmed & Cooled Cupholders',
      'Warmed & Cooled Front Seats',
      'Rear Seat Warmers',
      'Front & Rear Electric Adjustable Seats',
      ...
      'Multi-Select Ambient Lighting',
      'Dual Zone Front Automatic Air Conditioning',
      'Power Front Seats w/Driver Memory',
      '13-speaker Burmester Sound Surround System',
      'Remote Keyless Entry w/Integrated Key Transmitter',
      '4-Wheel Disc Brakes ABS',
      'Hill Descent Control',
      'Hill Hold Control',
      'Electric Parking Brake',
      'Original AMG Wheel Material Aluminum',
      'Adaptive Suspension',
      'Dual Stainless Steel Exhaust',
      'Mirrors Driver Auto Dimming',
      'ESP Crosswind Assist',
      'Electronic Stability Control (ESC)',
      'Roll Stability Control (RSC)',
      'ABS And Driveline Traction Control',
      'LDA (Lane Departure Assist)',
      'Blind Spot Assist Monitor',
      'Active Brake Assist (Autonomous Braking)'
    ]
  };
  ...
  const similarCars = [
    ...
    { title: '2018 BMW X5', price: 8500000, year: 2018, mileage: 55000, image: '/cars/gle/gle-02.jpg' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-mid-grey leading-relaxed">
            2019 Mercedes-Benz GLE400d AMG-Line with 9G-Tronic Automatic Transmission and 3000cc turbocharged diesel engine producing 330 BHP and 700nm of torque. This stunning black GLE features only 50k kms mileage, panoramic sunroof, and 7 black leather seats. Equipped with premium features including warmed & cooled front seats, multimedia display with Apple CarPlay, and 13-speaker Burmester sound system.
          </p>
        </div>
