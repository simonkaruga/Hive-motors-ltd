      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <RevealOnScroll>
          <a
            ...
            className="flex items-center justify-between bg-[#166638] text-white rounded-2xl p-6 mb-12 hover:bg-[#125530] transition-colors group shadow-lg shadow-green-400/20"
          >
