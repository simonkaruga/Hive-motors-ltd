        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-[#166638] text-white px-8 py-4 rounded-md font-semibold text-lg hover:bg-[#125530] transition-colors shadow-lg"
            >
